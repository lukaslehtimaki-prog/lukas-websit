      ...
      <Container>
        ...
        <div className="grid gap-4 lg:grid-cols-6">
          {t.features.cards.map((f, i) => {
            ...
            >
              <SpotCard className="group h-full rounded-2xl border border-white/[0.08] bg-[#0b0c12] p-7 transition-[transform,background-color,border-color] duration-200 ease-[var(--ease-out)] hover:-translate-y-0.5 hover:border-indigo-300/25 hover:bg-[#0d0e16]">
          ...
          <Reveal delay={t.features.cards.length * 70} className="lg:col-span-2">
            <Link
              href="/signup"
              className="group relative flex h-full flex-col justify-between rounded-2xl border border-indigo-400/25 bg-gradient-to-b from-indigo-500/[0.12] to-transparent p-7 transition-[transform,background-color,border-color] duration-200 ease-[var(--ease-out)] hover:-translate-y-0.5 hover:border-indigo-300/40"
            >
