...
export const metadata: Metadata = {
  title: "Terms of Service · Sitagio",
  description:
    "The terms governing your use of Sitagio's lead-finding and AI website-building service.",
};
  ...
  return (
    <article>
      ...
      <P>
        ...
        use of Sitagio (the &ldquo;Service&rdquo;), operated by Lukas Lehtimäki, a
      ...
      <H2>1. The Service</H2>
      <P>
        Sitagio helps you find local businesses (including those without a
      ...
      <P>
        ...
        EU marketing rules — when you do. Sitagio is a tool; it does not send
      ...
      <P>
        ...
        your clients&rsquo; use are yours. The Sitagio platform, including its
